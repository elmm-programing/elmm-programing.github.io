  ...
  <section class="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
      <div class="font-mono text-sm sm:text-base text-primary mb-6 break-all">
        <span class="text-ink-muted">&gt; elmm@portfolio:~$</span> status <span class="text-ink-muted">—</span> {{ $t('hero.tagline') }}<span class="cursor-blink text-primary">█</span>
      </div>

      <h1 class="text-4xl sm:text-5xl lg:text-7xl font-black tracking-tight leading-[1.1] mb-4 dark:text-white text-balance">
        {{ $t('hero.headline', { accent: $t('hero.headlineAccent') }) }}
      </h1>
