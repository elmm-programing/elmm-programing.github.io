  ...
  <section class="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
      <div class="font-mono text-sm sm:text-base text-primary mb-6 break-all">
        <span class="text-ink-muted">&gt; elmm@portfolio:~$</span> status <span class="text-ink-muted">—</span> Senior Full-Stack Developer <span class="text-ink-muted">|</span> React <span class="text-ink-muted">·</span> Vue <span class="text-ink-muted">·</span> Next.js <span class="text-ink-muted">·</span> Nuxt.js <span class="text-ink-muted">·</span> Node.js <span class="text-ink-muted">·</span> Go <span class="text-ink-muted">·</span> Java <span class="text-ink-muted">|</span> Remote LATAM<span class="cursor-blink text-primary">█</span>
      </div>
      ...
      <p class="mt-4 text-xl text-ink-muted dark:text-ink-muted max-w-2xl mx-auto font-light leading-relaxed">
        Go, Node.js and Java backend specialist. 4+ years operating SIGEF 2 — the Dominican Republic's national financial-management platform — at 99.9% uptime under federal audit cadence.
      </p>
...
const stack = ['React', 'Vue', 'Next.js', 'Nuxt.js', 'Node.js', 'Go', 'Java'];
</script>